    ...
    fn show(&mut self, ctx: &egui::Context) {
        ...
        egui::SidePanel::left("turbulence_controls").show(ctx, |ui| {
            ...
            if ui
                ...
                .on_hover_text("Preset for turbulent water flow in a pipe")
                .clicked()
            {
                self.density = 1000.0;
            ...
            if ui
                .button("✈️ Air over Wing")
                .on_hover_text("Preset for airflow over a flat plate")
                .clicked()
            {
                self.density = 1.225;
            ...
            if ui
                .button("🍯 Honey")
                .on_hover_text("Preset for highly viscous laminar flow")
                .clicked()
            {
                self.density = 1420.0;
