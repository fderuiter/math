...
impl ClimateTool for Co2ProjectionsTool {
    ...
    fn show(&mut self, ui: &mut egui::Ui) {
        ...
        ui.add(egui::Slider::new(&mut self.reduction_scenario, 0.0..=1.0).text("Emission Reduction Scenario"));

        let (historical, projected) = math_explorer::climate::dataset::get_co2_projections(self.reduction_scenario);
        ...
        plot.show(ui, |plot_ui| {
            ...
            let proj_line = Line::new("Projected CO2", proj_points).width(2.0).color(egui::Color32::RED);
