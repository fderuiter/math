...
pub use seir::{SEIRBuilder, SEIRModel, SEIRState};
pub use sir::{SIRBuilder, SIRModel, SIRState};

/// Helper macro for implementing arithmetic operations on compartmental states.
#[macro_export]
