...
// Re-export core items for backward compatibility
pub use proton::{larmor_frequency, boltzmann_ratio};
pub use bloch::BlochSimulator;
pub use scanner::{accumulated_phase, k_space_coordinate};
pub use reconstruction::{simulate_signal_2d, inverse_dft_2d};
