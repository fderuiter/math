...
// Re-export specific items to maintain backward compatibility where appropriate
// or just expose the modules. The original file had everything public or in pub mods.
// `BlochSimulator` was struct at top level.
// `proton`, `scanner`, `reconstruction` were modules.
