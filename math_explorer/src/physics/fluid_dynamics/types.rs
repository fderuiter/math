...
/// Encapsulates spatial derivatives required for flow calculations.
///
/// This parameter object groups the gradients required by momentum equations,
/// preventing argument list explosion and ensuring consistent data passing.
