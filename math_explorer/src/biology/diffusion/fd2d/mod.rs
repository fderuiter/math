...
use crate::math_kernel::types::{Dimension, StepSize};
...
mod tests_2d {
    ...
    fn test_laplacian_uniform() {
        let width = 10;
        let height = 10;
        let diff = FiniteDifference2D::new(crate::math_kernel::types::Dimension(width), crate::math_kernel::types::Dimension(height), crate::math_kernel::types::StepSize(1.0), crate::math_kernel::types::StepSize(1.0));
    ...
    fn test_diffusion_model_2d() {
        ...
        let dx = 1.0;
        let dy = 1.0;
        let diff = FiniteDifference2D::new(crate::math_kernel::types::Dimension(width), crate::math_kernel::types::Dimension(height), crate::math_kernel::types::StepSize(dx), crate::math_kernel::types::StepSize(dy));
