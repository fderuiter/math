...
pub trait DegradationModel {
    ...
    fn cycles_to_capacity(&self, target: Capacity, d: DepthOfDischarge)
        -> Result<Cycles, BatteryError>;
}
...
mod tests {
    ...
    fn test_standard_model_n70() {
        ...
        // DoD=100%, N70=300
        let n70_100 = model
            .n70(DepthOfDischarge::new(100.0).unwrap())
            .unwrap()
            .as_f64();
        assert!(
        ...
        // DoD=10%, N70=6000
        let n70_10 = model
            .n70(DepthOfDischarge::new(10.0).unwrap())
            .unwrap()
            .as_f64();
        assert!(
    ...
    fn test_cycles_to_capacity() {
        ...
        let cycles = model
            .cycles_to_capacity(Capacity::new(0.7).unwrap(), dod)
            .unwrap();
        ...
        let cycles_0 = model
            .cycles_to_capacity(Capacity::new(1.0).unwrap(), dod)
            .unwrap();
