...
/// A calculator for determining the favoritism score.
///
/// This struct enables dependency injection of the random number generator,
/// allowing for deterministic testing and control over the stochastic elements
/// of the model.
...
impl<R: Rng> FavoritismCalculator<R> {
    ...
    /// random perturbation `r` generated by the injected RNG.
    ///
    /// # Arguments
    ///
...
#[deprecated(
    since = "0.2.0",
    note = "Use `FavoritismCalculator` with an injected RNG instead."
)]
