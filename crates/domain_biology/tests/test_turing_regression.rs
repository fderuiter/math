...
fn test_turing_regression() {
    ...
    let mut system = TuringSystem::new(math_explorer::math_kernel::types::Dimension(size), domain_biology::biology::morphogenesis::DiffusionCoeff(0.1), domain_biology::biology::morphogenesis::DiffusionCoeff(0.05), math_explorer::math_kernel::types::StepSize(1.0));
...
fn test_custom_kinetics_strategy() {
    ...
    let mut system = TuringSystem::new_with_kinetics(math_explorer::math_kernel::types::Dimension(size), domain_biology::biology::morphogenesis::DiffusionCoeff(0.2), domain_biology::biology::morphogenesis::DiffusionCoeff(0.1), kinetics, diffusion);

    // Seed
    system.u_mut()[25] = 0.5;
    system.v_mut()[25] = 0.25;
