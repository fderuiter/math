...
//!
//! ```rust
//! use oxidize_biology::evolution::HawkDovePopulation;
//!
...
use oxidize_applied::game_theory::error::GameTheoryError;
use oxidize_applied::game_theory::evolutionary::ReplicatorDynamics;
use oxidize_pure_math::analysis::ode::{ArrayState, Euler, OdeSystem, Solver, SolverExt};
