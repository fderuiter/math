...
///
/// ```rust
/// use oxidize_biology::diffusion::FiniteDifference2D;
///
...
impl crate::reaction_diffusion::DiffusionModel for FiniteDifference2D {
    fn apply(
        &self,
        state: &crate::reaction_diffusion::ChemicalState,
        out: &mut crate::reaction_diffusion::ChemicalState,
        coeffs: &[f64],
    ) {
...
mod tests_2d {
    ...
    fn test_diffusion_model_2d() {
        use crate::reaction_diffusion::{ChemicalState, DiffusionModel};
