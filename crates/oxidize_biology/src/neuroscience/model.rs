...
use oxidize_pure_math::analysis::ode::OdeSystem;
...
///     The rate constants $\alpha_x$ and $\beta_x$ are determined by the [`GatingKinetics`](crate::neuroscience::kinetics::GatingKinetics) strategy.
#[derive(Debug, Clone)]
