...
///     The rate constants $\alpha_x$ and $\beta_x$ are determined by the [`GatingKinetics`](biology::neuroscience::kinetics::GatingKinetics) strategy.
#[derive(Debug, Clone)]
