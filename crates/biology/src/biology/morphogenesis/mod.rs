...
//!
//! ```rust
//! use biology::morphogenesis::{TuringSystem, SchnakenbergKinetics};
//!
...
use math_core::ode::{OdeSystem, TimeStepper};
...
use math_core::math_kernel::types::{Dimension, StepSize, DiffusionCoeff};
...
mod tests {
    ...
    fn test_derivative_in_place_safety_check() {
        let n = 10;
        let system = TuringSystem::new(math_core::math_kernel::types::Dimension(n), math_core::math_kernel::types::DiffusionCoeff(1.0), math_core::math_kernel::types::DiffusionCoeff(1.0), math_core::math_kernel::types::StepSize(1.0));
    ...
    fn test_turing_system_logic_preservation() {
        ...
        let d_v = 0.5;
        let dx = 1.0;
        let mut system = TuringSystem::new(math_core::math_kernel::types::Dimension(n), math_core::math_kernel::types::DiffusionCoeff(d_u), math_core::math_kernel::types::DiffusionCoeff(d_v), math_core::math_kernel::types::StepSize(dx));
