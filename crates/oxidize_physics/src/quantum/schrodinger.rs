...
use crate::quantum::types::{QuantumOperator, QuantumState};
...
///
/// ```
/// use oxidize_physics::quantum::{time_evolution_operator, sigma_z};
...
///
/// ```
/// use oxidize_physics::quantum::schrodinger::evolve_state;
/// use oxidize_physics::quantum::types::{QuantumState, QuantumOperator};
