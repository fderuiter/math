...
use oxidize_pure_math::analysis::ode::{OdeSystem, Solver, TimeStepper};
...
///
/// ```
/// use oxidize_physics::chaos::lorenz::{LorenzBuilder, LorenzState};
/// use oxidize_pure_math::analysis::ode::TimeStepper;
///
...
impl TimeStepper<Vector3<f64>> for LorenzSystem {
    ...
    fn step(&mut self, dt: f64) {
        use oxidize_pure_math::analysis::ode::RungeKutta4;
