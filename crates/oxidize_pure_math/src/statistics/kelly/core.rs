...
impl EdgeProbability {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::kelly::EdgeProbability;
    ///
...
impl Odds {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::kelly::Odds;
    ///
...
impl BankrollFraction {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::kelly::BankrollFraction;
    ///
