...
impl MeanReversionRate {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::ou_process::MeanReversionRate;
    ///
...
impl Volatility {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::ou_process::Volatility;
    ///
...
impl LongTermMean {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::ou_process::LongTermMean;
    ///
...
impl OuParams {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::ou_process::{
