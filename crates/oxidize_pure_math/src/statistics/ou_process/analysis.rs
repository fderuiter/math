...
impl MomentumType {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::ou_process::{MomentumType, MeanReversionRate};
    ///
...
impl OuAnalyzer {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::ou_process::{OuAnalyzer, OuParams, TimeStep};
    ///
...
///
/// ```
/// use oxidize_pure_math::statistics::ou_process::estimate_ou_params;
///
