...
impl Probability {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::copula::Probability;
    ///
...
impl Correlation {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::copula::Correlation;
    ///
...
impl CorrelationMatrix {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::copula::{CorrelationMatrix, Correlation};
    ///
    /// let rho = Correlation::new(-0.3).unwrap();
