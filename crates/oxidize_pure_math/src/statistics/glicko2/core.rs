...
impl Rating {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::glicko2::Rating;
    ///
...
impl RatingDeviation {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::glicko2::RatingDeviation;
    ///
...
impl Volatility {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::glicko2::Volatility;
    ///
...
impl SystemConstant {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::glicko2::SystemConstant;
    ///
...
impl GlickoPlayer {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::glicko2::{GlickoPlayer, Rating, RatingDeviation, Volatility};
    ///
...
impl MatchResult {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::glicko2::{MatchResult, GlickoPlayer};
    ///
