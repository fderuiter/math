...
impl ZipDistribution {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::zip_regression::{ZipDistribution, ZipParams};
    ///
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::zip_regression::{ZipDistribution, Count};
    ///
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::zip_regression::ZipDistribution;
    ///
    /// let dist = ZipDistribution::from_values(0.2, 3.0).unwrap();
    /// let mean = dist.mean();
