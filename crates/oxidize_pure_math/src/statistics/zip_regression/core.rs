...
impl PoissonRate {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::zip_regression::PoissonRate;
    ///
...
impl ZeroInflation {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::zip_regression::ZeroInflation;
    ///
...
impl ZipParams {
    ...
    ///
    /// ```
    /// use oxidize_pure_math::statistics::zip_regression::{ZipParams, ZeroInflation, PoissonRate};
    ///
