...
use crate::number_theory::alcf::sigma;
use crate::number_theory::ambs::{AmbsDsp, modular_inverse, prime_factors};
use crate::number_theory::primes::is_prime;
...
///
/// ```rust
/// use oxidize_pure_math::number_theory::ualbf::phase1_global_annihilation_sieve;
...
///
/// ```rust
/// use oxidize_pure_math::number_theory::ualbf::{phase1_global_annihilation_sieve, phase2_build_prefix_tree};
/// use rug::Integer;
...
///
/// ```rust
/// use oxidize_pure_math::number_theory::ualbf::{Prefix, phase3_lattice_oracle_rejects};
/// use rug::Integer;
...
///
/// ```rust
/// use oxidize_pure_math::number_theory::ualbf::{Prefix, phase4_exact_ray_casting};
/// use rug::Integer;
/// let prefix = Prefix { n_l: Integer::from(49u64), s_l: Integer::from(57u64), factors: vec![7] };
