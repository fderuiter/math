...
impl NormalTransform {
    ...
    ///
    /// ```
    /// use pure_math::statistics::copula::NormalTransform;
    ///
...
///
/// ```
/// use pure_math::statistics::copula::{inverse_standard_normal, Probability};
///
...
///
/// ```
/// use pure_math::statistics::copula::standard_normal_cdf;
///
/// let z = 1.96;
