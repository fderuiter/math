...
impl MeanReversionRate {
    ...
    ///
    /// ```
    /// use pure_math::statistics::ou_process::MeanReversionRate;
    ///
...
impl Volatility {
    ...
    ///
    /// ```
    /// use pure_math::statistics::ou_process::Volatility;
    ///
...
impl LongTermMean {
    ...
    ///
    /// ```
    /// use pure_math::statistics::ou_process::LongTermMean;
    ///
...
impl OuParams {
    ...
    ///
    /// ```
    /// use pure_math::statistics::ou_process::{
