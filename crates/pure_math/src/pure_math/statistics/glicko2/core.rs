...
impl Rating {
    ...
    ///
    /// ```
    /// use pure_math::statistics::glicko2::Rating;
    ///
...
impl RatingDeviation {
    ...
    ///
    /// ```
    /// use pure_math::statistics::glicko2::RatingDeviation;
    ///
...
impl Volatility {
    ...
    ///
    /// ```
    /// use pure_math::statistics::glicko2::Volatility;
    ///
...
impl SystemConstant {
    ...
    ///
    /// ```
    /// use pure_math::statistics::glicko2::SystemConstant;
    ///
...
impl GlickoPlayer {
    ...
    ///
    /// ```
    /// use pure_math::statistics::glicko2::{GlickoPlayer, Rating, RatingDeviation, Volatility};
    ///
...
impl MatchResult {
    ...
    ///
    /// ```
    /// use pure_math::statistics::glicko2::{MatchResult, GlickoPlayer};
    ///
