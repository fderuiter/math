...
impl PoissonRate {
    ...
    ///
    /// ```
    /// use pure_math::statistics::zip_regression::PoissonRate;
    ///
...
impl ZeroInflation {
    ...
    ///
    /// ```
    /// use pure_math::statistics::zip_regression::ZeroInflation;
    ///
...
impl ZipParams {
    ...
    ///
    /// ```
    /// use pure_math::statistics::zip_regression::{ZipParams, ZeroInflation, PoissonRate};
    ///
