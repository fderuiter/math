...
impl ZipDistribution {
    ...
    ///
    /// ```
    /// use pure_math::statistics::zip_regression::{ZipDistribution, ZipParams};
    ///
    ...
    ///
    /// ```
    /// use pure_math::statistics::zip_regression::{ZipDistribution, Count};
    ///
    ...
    ///
    /// ```
    /// use pure_math::statistics::zip_regression::ZipDistribution;
    ///
    /// let dist = ZipDistribution::from_values(0.2, 3.0).unwrap();
    /// let mean = dist.mean();
