...
///
/// ```rust
/// use pure_math::tensor::differentiation::covariant_derivative_contravariant;
/// use pure_math::tensor::{RiemannianMetric, ContravariantVector};
/// use nalgebra::{DMatrix, DVector};
///
...
///
/// ```rust
/// use pure_math::tensor::differentiation::covariant_derivative_covariant;
/// use pure_math::tensor::{RiemannianMetric, CovariantVector};
/// use nalgebra::{DMatrix, DVector};
///
/// // Define a flat Euclidean metric space
/// let metric = RiemannianMetric::new(|_| DMatrix::identity(2, 2));
