...
///
/// ```
/// use pure_math::elliptic_curves::prime_factors;
...
///
/// ```
/// use pure_math::elliptic_curves::psi;
/// assert_eq!(psi(1), 1);
...
///
/// ```
/// use pure_math::elliptic_curves::{theorem_1_1_bounds, Theorem11Bounds};
...
///
/// ```
/// use pure_math::elliptic_curves::{theorem_1_2_bounds, Theorem12Bounds};
