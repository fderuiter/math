...
///
/// ```
/// use pure_math::analysis::roots::{RootFinder, Bisection, NewtonRaphson};
///
/// fn main() -> Result<(), pure_math::analysis::roots::AnalysisError> {
...
///
/// ```
/// use pure_math::analysis::roots::{RootFinder, Bisection};
///
/// fn main() -> Result<(), pure_math::analysis::roots::AnalysisError> {
...
///
/// ```
/// use pure_math::analysis::roots::{RootFinder, NewtonRaphson};
///
/// fn main() -> Result<(), pure_math::analysis::roots::AnalysisError> {
