...
///
/// ```rust
/// use physics::fluid_dynamics::potential_flow::{FlowElement, Source};
///
...
///
/// ```rust
/// use physics::fluid_dynamics::potential_flow::{FlowElement, Vortex};
///
...
///
/// ```rust
/// use physics::fluid_dynamics::potential_flow::{FlowElement, Doublet};
///
