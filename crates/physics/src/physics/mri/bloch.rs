...
use super::proton;
use math_core::ode::{Euler, OdeSystem, Solver, SolverExt, TimeStepper};
...
impl SimulationModel for BlochSimulator {
    ...
    fn step(&mut self) -> Result<(), Self::Error> {
        <Self as math_core::ode::TimeStepper<Vector3<f64>>>::step(self, 0.01);
        Ok(())
    }
