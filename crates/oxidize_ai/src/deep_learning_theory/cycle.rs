...
use crate::optimization::{Optimizer, cross_entropy_softmax_prime};
...
impl<M: Trainable> TrainingLoop<M> {
    ...
    /// use oxidize_ai::deep_learning_theory::cycle::TrainingLoop;
    ///
    ...
    pub fn train_step(
        ...
        x: &Vector,
        y_true: &Vector,
    ) -> Result<f64, crate::optimization::OptimizationError> {
