...
//!
//! ```rust
//! use applied::win_ratio::pair_comparison::{
...
//! ## Modules
//!
//! - [`pair_comparison`](applied::win_ratio::pair_comparison): Core logic for matched and unmatched pair comparisons.
//! - [`sample_win_ratio`](applied::win_ratio::sample_win_ratio): Tools for sample-based estimation.
//! - [`probability_win_ratio`](applied::win_ratio::probability_win_ratio): Theoretical probability calculations.
