use pure_math::analysis::roots::{AnalysisError, Bisection, RootFinder};
use rand::Rng;
...
/// # Example
/// ```
/// use applied::game_theory::mechanism_design::optimal_reserve_price;
...
#[deprecated(
    since = "0.2.0",
    note = "MechanismDesign struct is deprecated. Use the module-level functions directly."
)]
...
impl MechanismDesign {
    ...
    pub fn optimal_reserve_price<D: ValuationDistribution>(
        ...
        optimal_reserve_price(dist, lower_bound, upper_bound)
    }
    ...
    pub fn optimal_reserve_price_with_solver<D: ValuationDistribution, S: RootFinder>(
        ...
        optimal_reserve_price_with_solver(dist, lower_bound, upper_bound, solver)
    }
    ...
    pub fn simulate_optimal_revenue<D: ValuationDistribution>(
        ...
        simulate_optimal_revenue(dist, n_bidders, n_simulations)
    }
    ...
    pub fn simulate_optimal_revenue_with_rng<D: ValuationDistribution, R: Rng + ?Sized>(
        ...
        simulate_optimal_revenue_with_rng(dist, n_bidders, n_simulations, rng)
    }
}
