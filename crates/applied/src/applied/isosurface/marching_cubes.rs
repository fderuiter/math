...
impl<'a, G: GradientEstimator> MarchingCubes<'a, G> {
    ...
    ///
    /// ```rust
    /// use applied::isosurface::{CentralDifferenceEstimator, VoxelGrid, Point3D};
    /// use applied::isosurface::marching_cubes::MarchingCubes;
    ///
...
///
/// ```
/// use applied::isosurface::{extract_isosurface, VoxelGrid, Point3D};
///
