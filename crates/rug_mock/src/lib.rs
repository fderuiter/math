...
impl Integer {
    ...
    pub fn from<T: Into<BigInt>>(v: T) -> Self {
        Integer(v.into())
    }
    ...
    pub fn assign(&mut self, v: i128) {
        self.0 = BigInt::from(v);
    }
    #[allow(clippy::result_unit_err)]
    pub fn parse(s: &str) -> Result<Self, ()> {
        s.parse::<BigInt>().map(Integer).map_err(|_| ())
    }
    #[allow(clippy::result_unit_err)]
    ...
    pub fn abs(self) -> Self {
        Integer(num_traits::Signed::abs(&self.0))
    }
}
...
pub mod ops {
    ...
    impl RemRounding<super::Integer> for super::Integer {
        ...
        fn rem_euc(self, rhs: super::Integer) -> Self::Output {
            super::Integer(super::NumInteger::mod_floor(&self.0, &rhs.0))
        }
    }
    impl RemRounding<&super::Integer> for super::Integer {
        type Output = super::Integer;
