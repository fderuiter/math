...
use oxidize_ai::optimization::{Optimizer, SGD};
use crate::autoencoder::AutoencoderModel;
use crate::cera::Cera;
use crate::loss::{cera_loss, earth_movers_distance, mse_loss};
...
impl<'a, A: AutoencoderModel, P: PredictorModel, O: Optimizer<f32>> CeraTrainer<'a, A, P, O> {
    ...
    fn optimizer_step(&mut self) -> Result<(), oxidize_ai::optimization::OptimizationError> {
