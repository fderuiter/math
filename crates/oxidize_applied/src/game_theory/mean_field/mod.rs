...
//!
//! ```rust
//! use oxidize_applied::game_theory::mean_field::{MFGConfig, FixedPointSolver, MFGSolver};
//!
//! // 1. Configuration
//! // Viscosity (noise) = 0.1, Time Horizon = 1.0
//! // Grid: 50 spatial points, 100 time steps. Range: [-2.0, 2.0]
//! use std::num::NonZeroUsize;
//! use oxidize_applied::game_theory::mean_field::types::MFGConfigBuilder;
...
//! use oxidize_applied::game_theory::mean_field::types::{Density, Position};
...
/// ```rust
/// use std::num::NonZeroUsize;
/// use oxidize_applied::game_theory::mean_field::{MeanFieldGame1D, MFGConfigBuilder};
