...
//!
//! ```rust
//! use oxidize_applied::clinical_trials::design::{simple_randomization, Group};
//! use oxidize_applied::clinical_trials::sample_size::calculate_sample_size_means;
//! use oxidize_applied::clinical_trials::analysis::calculate_risk_metrics;
//! use oxidize_applied::clinical_trials::types::ContingencyTable;
//!
//! fn main() {
