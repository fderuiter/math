...
## 2025-05-13 - [Optimization] **Bottleneck:** O(N^2) Partition Function (f_k) Calculation **Strategy:** Euler's Pentagonal Number Theorem (O(sqrt(N))) **Gain:** 41,000x speedup (3.23s -> 78µs) for precision=10000
