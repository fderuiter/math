...
## 2024-10-24 - [Optimization] **Bottleneck:** Isosurface extraction (Memory Access & Indexing) **Strategy:** Sliding Window + Lazy Gradient + Direct Indexing **Gain:** ~222ms -> ~125ms (43% reduction)
