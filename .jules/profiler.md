...
## 2025-05-21 - [Optimization] **Bottleneck:** O(N) Allocations in Generic ODE Solver for VecState **Strategy:** In-place mutation (Reuse self) **Gain:** 30-50% speedup on Add/Mul operations
