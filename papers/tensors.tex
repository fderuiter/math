...
You’re seeing the standard proof that \textbf{coupling two irreducible spherical tensors gives another irreducible tensor}.
...
\begin{enumerate}
    ...
    \item Use the \textbf{CG series} for products of $D$-matrices:
    \begin{equation}
    ...
    \item Sum over $q_1,q_2$ and use the \textbf{orthogonality of CG coefficients}:
    \begin{equation}
...
Conceptually, this is the operator version of \textbf{adding angular momenta}; it corresponds to the direct-product representation $k_1\otimes k_2$.
