...
The core logic is located in the `math_explorer::pure_math::number_theory` module, which is further divided into:
\begin{itemize}
...
The `class_number` function is implemented by counting the number of reduced, primitive, positive-definite binary quadratic forms of a given discriminant, following the algorithm described in \cite{cohen1993course}.
...
\bibitem{tsai2025montgomery}
Tsai Yi-Ju,
\textit{A Novel Summation Formula for the Hurwitz-Kronecker Class Number},
arXiv:2509.08281v1, 2025.
...
\bibitem{brown2008elliptic}
Brittany Brown et al.,
\textit{Elliptic curves, modular forms, and sums of Hurwitz class numbers},
Journal of Number Theory 128.6 (2008): 1847-1863.

\bibitem{zagier1975nombres}
Don Zagier,
\textit{Nombres de classes et formes modulaires de poids 3/2},
Seminaire de Théorie des Nombres de Bordeaux 4 (1974-1975): 1-2.
