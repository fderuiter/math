...
The core logic is located in the \texttt{math_explorer::pure_math::number_theory} module, which is further divided into:
\begin{itemize}
...
The \texttt{class_number} function is implemented by counting the number of reduced, primitive, positive-definite binary quadratic forms of a given discriminant, following the algorithm described in \cite{cohen1993course}.
