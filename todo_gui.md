...
*   **Features:**
    *   Bloch Simulator (magnetization vector evolution).
    *   Controls for $T_1$, $T_2$, $\vec{B}$-field, and $M_0$.
    *   Real-time plotting of $M_x, M_y, M_z$.
...
*   **Features:**
    *   **Flow Visualization:** 2D heatmap or vector field plot of velocity/pressure.
